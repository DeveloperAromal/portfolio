export const works = [
  ...
  },
  {
    title: "LinkLens",
    description:
      "LinkLens is a lightweight React npm package that automatically detects URLs in any text (comments, chat messages, posts) and highlights them",
    ...
    points: [
      ...
      "Works with chat messages, comments, posts, blogs, and forums ",
    ],
    bg: "bg-indigo-700",

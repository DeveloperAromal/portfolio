...
export default function NavBar() {
  ...
  return (
    <header className="fixed z-50 top-6 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-4xl bg-white/5 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 border border-neutral-500 max-w-4xl">
      ...
      {menuOpen && (
        <div className="mt-4 md:hidden flex flex-col items-center gap-6 text-neutral-300 text-base transition-all duration-300">

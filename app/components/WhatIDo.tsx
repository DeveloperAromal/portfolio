...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={first}
        className="h-full w-1/3 rounded-2xl bg-black p-4 border-white/[0.1] border flex flex-col items-center justify-center"
      >
        <Image
      ...
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-black p-4 border-white/[0.1] border flex flex-col items-center justify-center">
        <Image
          src="https://pbs.twimg.com/profile_images/1417752099488636931/cs2R59eW_400x400.jpg"
          alt="avatar"
          height="100"
